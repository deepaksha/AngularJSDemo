...
- TO test if system have node js installed
	 a) open the Windows Command Prompt, Powershell or a similar command line tool,
	 b) type node -v 
	 c) if install it will give node version other wise undefined oprable error message.
...
2) How to run the program
	a) Download or git clone the project from git repo
